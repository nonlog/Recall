...
- This follow-up distinguishes an unsupported source from a verified Pi orphan. Pi root traversal now propagates scan errors; only a complete successful scan with zero source-id matches may classify native data as already absent.
